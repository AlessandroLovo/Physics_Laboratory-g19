...
\end{figure}
\todo[inline]{Serve davvero fig \ref{fig:lemo_length}? Sarebbe piuttosto meglio mettere il grafico del fit lineare della calibrazione dei 5 picchi TAC - secondo me è interessante, però se abbiamo problemi di spazio possiamo toglierla}
...
\section{Conclusions}
\todo[inline]{Dire qualcosa sul fatto ch siamo incompatibili con il valore teorico -> conclusioni }
