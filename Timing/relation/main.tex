...
The observed Compton Edge (CE) is a convolution of the real CE with a gaussian noise whose width is proportional to the resolution of the detector $\sigma_{res}$; this convolution results in a shift of the maximum of the CE towards lower energies, so, in order to calibrate the detecters, we need to obtain an estimate of this shift.
