...
Using a Langmuir probe an estimate of plasma parameters, such as density, electron temperature and plasma potential, can be obtained.%, throw electric parameters of the filament of which the probe is composed.
\todo[inline]{In generale, \emph{formula} è una brutta parola, molto matematica e poco fisica. In fisica si parla di \emph{relation}.}
...
For the characterization of the plasma, two Langmuir probes have been used: one on the same side of the filament ("filament side"), and one on the opposite side, near the pumping group ("pump side").

\subsection{Dependence on discharge polarization voltage}

In figures \ref{fig:Lang:dx} and \ref{fig:Lang:sx} the voltage--current characteristic measured at different polarization voltage, keeping fixed pressure and filament current, are reported.

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{dx_char.tex}}
	\caption{Electrical voltage--current characteristic of the Langmuir probe for a pressure of $2.84\si{\mu\bar}$, a filament current of $6.5\si{\ampere}$ and different discharge polarization voltages; \emph{filament-side} probe.}
	\label{fig:Lang:dx}
\end{figure}
\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{sx_char.tex}}
	\caption{Electrical voltage--current characteristic of the Langmuir probe for a pressure of $2.84\si{\mu\bar}$, a filament current of $6.5\si{\ampere}$ and different discharge polarization voltages; \emph{pump-side} probe.}
	\label{fig:Lang:sx}
\end{figure}

Plasma parameters are obtained from the characteristics through interpolations and the previous relations, and are represented with respect to filament  discharge characteristics (discharge voltage and discharge current).

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{Te.tex}}
	\caption{Dependence of electronic temperature on discharge polarization voltage, for a pressure of $2.84\si{\mu\bar}$ and a filament current of $6.5\si{\ampere}$. The errors have been estimated as $25\%$ in the temperature and $1\si{\volt}$ in the voltage.}
	\label{fig:Lang:Te}
\end{figure}

\todo[inline]{Si riesce ad inserire le barre di errore nel grafico?}
\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{n.tex}}
	\caption{Dependence of density on discharge polarization voltage, for a pressure of $2.84\si{\mu\bar}$ and a filament current of $6.5\si{\ampere}$. The errors have been estimated as $20\%$ in the density and $1\si{\volt}$ in the voltage.}
	\label{fig:Lang:n}
\end{figure}

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{Vp.tex}}
	\caption{Dependence of plasma potential on discharge polarization voltage, for a pressure of $2.84\si{\mu\bar}$ and a filament current of $6.5\si{\ampere}$. The errors have been estimated as $15\%$ in the potential and $1\si{\volt}$ in the voltage.}
	\label{fig:Lang:Vp}
\end{figure}

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{Te_c.tex}}
	\caption{Dependence of electronic temperature on discharge current, for a pressure of $2.84\si{\mu\bar}$ and a filament current of $6.5\si{\ampere}$. The errors have been estimated as $25\%$ in the temperature and $\pm1\si{m\ampere}$ in the discharge current.}
	\label{fig:Lang:Te_c}
\end{figure}

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{n_c.tex}}
	\caption{Dependence of density on discharge current, for a pressure of $2.84\si{\mu\bar}$ and a filament current of $6.5\si{\ampere}$. The errors have been estimated as $20\%$ in the density and $\pm1\si{m\ampere}$ in the discharge current.}
	\label{fig:Lang:n_c}
\end{figure}
\todo[inline]{$\chi^2 = 10^{31}$ \`e irrealistico se gli errori sono quelli che hai scritto}


\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{Vp_c.tex}}
	\caption{Dependence of plasma potential on discharge current, for a pressure of $2.84\si{\mu\bar}$ and a filament current of $6.5\si{\ampere}$. The errors have been estimated as $15\%$ in the potential and $\pm1\si{m\ampere}$ in the discharge current.}
	\label{fig:Lang:Vp_c}
\end{figure}
\todo[inline]{Direi bene. Se si riesce, sarebbe bene mettere le barre di errore nei grafici. Nella fig. 17 se non ce ne facciamo nulla dell'interpolazione meglio togliere i valori dei parametri (ma si può lasciare il fit, così tratteggiato è carino; se è uno sbatti lasciamo anche così). Se si riesce a mettere una immagine, a titolo esemplificativo, sarebbe bello! (ma non fondamentale)}

\subsection{Dependence on filament current}
In figures \ref{fig:Lang:dx_cur} and \ref{fig:Lang:sx_cur} the voltage--current characteristic measured at different filament current, keeping fixed pressure and polarization voltage, are reported.

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{dx_char_cur.tex}}
	\caption{Electrical voltage--current characteristic of the Langmuir probe for a pressure of $2.84\si{\mu\bar}$, a polarization voltage of $40\si{\volt}$ and different filament currents (as described in legend); \emph{filament-side} probe.}
	\label{fig:Lang:dx_cur}
\end{figure}

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{sx_char_cur.tex}}
	\caption{Electrical voltage--current characteristic of the Langmuir probe for a pressure of $2.84\si{\mu\bar}$, a polarization voltage of $40\si{\volt}$ and different filament currents (as described in legend); \emph{pump-side} probe.}
	\label{fig:Lang:sx_cur}
\end{figure}

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{Te_f.tex}}
	\caption{Dependence of electronic temperature on filament current, for a pressure of $2.84\si{\mu\bar}$ and a polarization voltage of $40\si{\volt}$. The errors have been estimated as $5\%$ in the temperature and $0.1\si{\ampere}$ in the current.}
	\label{fig:Lang:Te_f}
\end{figure}

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{n_f.tex}}
	\caption{Dependence of plasma potential on filament current, for a pressure of $2.84\si{\mu\bar}$ and a polarization voltage of $40\si{\volt}$. The errors have been estimated as $10\%$ in the density and $0.1\si{\ampere}$ in the current.}
	\label{fig:Lang:n_f}
\end{figure}

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{Vp_f.tex}}
	\caption{Dependence of density on filament current, for a pressure of $2.84\si{\mu\bar}$ and a polarization voltage of $40\si{\volt}$. The errors have been estimated as $5\%$ in the density and $0.1\si{\ampere}$ in the current.}
	\label{fig:Lang:Vp_f}
\end{figure}

\subsection{Dependence on pressure}
In figures \ref{fig:Lang:dx_cur} and \ref{fig:Lang:sx_cur} the voltage--current characteristic measured at different pressure, keeping fixed filament current and polarization voltage, are reported.
\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{dx_char_p.tex}}
	\caption{Electrical voltage--current characteristic of the Langmuir probe for a filament current of $6.5\si{\ampere}$, a polarization voltage of $40\si{\volt}$ and different pressures (as described in legend); \emph{filament-side} probe.}
	\label{fig:Lang:dx_p}
\end{figure}

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{sx_char_p.tex}}
	\caption{Electrical voltage--current characteristic of the Langmuir probe for a filament current of $6.5\si{\ampere}$, a polarization voltage of $40\si{\volt}$ and different pressures (as described in legend); \emph{pump-side} probe.}
	\label{fig:Lang:sx_p}
\end{figure}

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{Te_p.tex}}
	\caption{Dependence of electronic temperature on the chamber pressure, for a filament current of $6.5\si{m\ampere}$ and a polarization voltage of $40\si{\volt}$. The errors have been estimated as $15\%$ in the temperature and $5\tcperthousand$ in the pressure. Logarithmic scale has been used for both axis.}
	\label{fig:Lang:Te_p}
\end{figure}

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{n_p.tex}}
	\caption{Dependence of density on the chamber pressure, for a filament current of $6.5\si{m\ampere}$ and a polarization voltage of $40\si{\volt}$. The errors have been estimated as $20\%$ in the density and $5\tcperthousand$ in the pressure. Logarithmic scale has been used for X axis.}
	\label{fig:Lang:n_p}
\end{figure}

\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\import{img/Langmuir/}{Vp_p.tex}}
	\caption{Dependence of plasma potential on the chamber pressure, for a filament current of $6.5\si{m\ampere}$ and a polarization voltage of $40\si{\volt}$. The errors have been estimated as $20\%$ in the potential and $5\tcperthousand$ in the pressure. Logarithmic scale has been used for X axis.}
	\label{fig:Lang:Vp_p}
\end{figure}
