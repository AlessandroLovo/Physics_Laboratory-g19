...
Pumping the vessel to a low pressure ($\sim 2 $ \todo[inline]{missing unit} ), the voltage-current characteristic curve of the filament has been measured, producing the following data:
...
\todo[inline]{Si potrebbe provare a fare un fit con la formula di Paschen: i dati sembrano piuttosto belli}
...
\todo[inline]{Non \`e ben chiaro questo discorso di $d_0$}
\begin{equation*}
