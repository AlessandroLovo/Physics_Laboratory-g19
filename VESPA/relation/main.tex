...
The graph \ref{fig:f}(d) shows that the ionization fraction decreases fastly when pressure increase. This can be related to the smaller free path of electrons due to higher number of atoms in the chamber. For pressures higher than $10\si{\micro\bar}$ the ionization fraction becomes very small.
%
\begin{figure}[H]
\makebox[\textwidth][c]{
\hspace{0.03\textwidth}%
