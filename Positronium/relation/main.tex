...
% making an a-posteriori coincidence with the detector 4 only for the timing studies.
\begin{figure}[H]
    \centering
...
Anyways even if the TAC detects a valid event we cannot be sure that its \emph{start} was actually the photon from the \ce{^22Na} that produced the positronium whose decay we observed.
