...
\todo[inline]{Grafici per la calibrazione}
...
\begin{gather*}
    ...
    m_{2\gamma} = ( 117 \pm 1 )\si{\nano\second} \\
    m_{3\gamma} = ( 87.4 \pm 0.4 )\si{\nano\second}
\end{gather*}
...
\todo[inline]{Compute these stuffs}
\begin{table}[H]
    \centering
    \begin{tabular}{cccccccc}
        \toprule
...
\todo[inline]{- Spettri energia calibrati (picchi 1 a 511, 2 a 511, 4 a 1275); - Spettro TAC, spiegazione interpretazione e convoluzione, fit e discussione)}
...
\todo[inline]{- Spettri energia calibrati (picchi 1,2 e 3 a 340); - Spettro somma delle energie - Spettro TAC e discussione)}
