...
Plotting the data in table \ref{tab:rate}, we obtain the plot in figs. \ref{fig:deadtime}, \ref{fig:deadtime:fit}
...
\todo{I smalled the graphs to fit them in the same page ... does it make sense?}
...
\todo[inline]{To be reviewed: seems ok}
\end{document}
